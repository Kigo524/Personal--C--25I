...
void avanzar(){
    ...
    printf("A que direccion deberia moverse el pirata?\n");
    scanf("%d", &direccion);

    //determinar la direccion
    switch(direccion){
        case 1: //norte
            printf("El pirata avanza al NORTE\n");
            nuevoX = pirataX - 1;
            break;
        case 2: //sur
            printf("El pirata avanza al SUR\n");
            nuevoX = pirataX + 1;
            break;
        case 3: //este
            printf("El pirata avanza al ESTE\n");
            nuevoY = pirataY + 1;
            break;
        case 4: //oeste
            printf("El pirata se mueve al OESTE\n");
            nuevoY = pirataY - 1;
            break;
    }
